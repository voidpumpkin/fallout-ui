// Copied and modified based on https://github.com/jsanahuja/Notifierjs/blob/7f7f616632abb264a465ad035e220dfda369c68e/src/Notifier.js
(function (root, factory) {
  ...
  var Notification = function (
    ...
    switch (notifier.options.direction) {
      case "top":
        notifier.container.insertBefore(
          this.element,
          notifier.container.childNodes[0]
        );
        break;
      case "bottom":
      default:
  ...
  var Notifier = function (opts) {
    ...
    this.container = document.getElementById(
      "notifyjs-container-" + this.options.position
    );
    ...
    this.notify = function (type, msg, time, callback) {
      if (typeof this.options[type] === "undefined") {
        console.error(
          "Notify.js: Error, undefined '" + type + "' notification type"
        );
        return;
      }
