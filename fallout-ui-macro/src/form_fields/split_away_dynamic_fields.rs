...
pub fn split_away_dynamic_fields(named_fields: FieldsNamed) -> (Vec<Field>, (Vec<Field>, Vec<Type>, Vec<Type>)) {
    ...
    let dynamic_fields: (Vec<Field>, Vec<Type>, Vec<Type>) = (dynamic_fields.0, unziped_key_values.0, unziped_key_values.1);
